...
const PricingSection: React.FC = () => {
  ...
  const price = isMonthly ? "7,500" : "82,500"; // NGN 7,500 * 11 months (assuming 1 free month in yearly)
  ...
  return (
    <section
      id="pricing"
      className="py-20 md:py-32 bg-linear-to-b from-slate-200 via-violet-100 to-gray-200 text-gray-900"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 text-center">
        <p className="text-xs font-bold uppercase tracking-widest bg-violet-100 text-black mb-2 p-1 border border-violet-500 inline-block rounded-full px-6 py-2">
          LEGAL MADE SIMPLE
        </p>
        <h2 className="text-4xl md:text-5xl font-extrabold mb-4">Pricing</h2>
        ...
        <div className="inline-flex bg-violet-200 px-6 py-2 rounded-full mb-12 shadow-inner cursor-pointer">
          <button
            type="button"
        ...
        <div className="max-w-4xl mx-auto bg-violet-50 rounded-3xl p-8 md:p-16 text-left shadow-xl border border-gray-200">
